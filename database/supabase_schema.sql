...
CREATE TABLE IF NOT EXISTS player_stats (
    ...
    last_daily_reward NUMERIC(20, 2) DEFAULT 0,
...
-- Table: transactions (For Payment/Donation)
CREATE TABLE IF NOT EXISTS transactions (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    user_id BIGINT, -- Can be null if not yet identified, but logic usually requires it
    amount NUMERIC(20, 2) DEFAULT 0,
    description TEXT, -- Order Code
    status TEXT DEFAULT 'pending', -- pending, success, late_payment, expired
